...
user_dict_path = '/opt/ml/input/data/training/user_dict.txt'
user_dict_path_2 = '/opt/ml/input/data/training/user_dict_2.txt'
...
data_json = '/opt/ml/input/data/training/train.json'
...
config_path = '/opt/ml/input/data/roberta/bert_config.json'
checkpoint_path = '/opt/ml/input/data/roberta/bert_model.ckpt'
dict_path = '/opt/ml/input/data/roberta/vocab.txt'
...
nezha_config_path = '/opt/ml/input/data/nezha/bert_config.json'
nezha_checkpoint_path = '/opt/ml/input/data/nezha/model.ckpt-900000'
nezha_dict_path = '/opt/ml/input/data/nezha/vocab.txt'
